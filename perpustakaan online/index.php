...
$sql = mysqli_query($koneksi, "SELECT * FROM tw_blog INNER JOIN tw_user ON tw_blog.blog_user=tw_user.user_username ORDER BY blog_id DESC LIMIT $offset, $dataPerPage");
